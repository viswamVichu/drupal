...
import CustomTableClassPlugin from './plugins/CustomTableClassPlugin';
...
const plugins = [ 
  ...
  ShowBlocks,
  AutoLink,
  Table, TableCaption, TableCellProperties, TableColumnResize, TableProperties, TableToolbar, CustomTableClassPlugin,
  ...
  Indent, IndentBlock,
  GeneralHtmlSupport, Style, Base64UploadAdapter
];
